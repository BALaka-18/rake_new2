                ...
                <MDBRow>
                    <MDBCol md='6' className='text-center mt-xl-5 mb-5'>
                        <MDBAnimation type='fadeInUp' delay='.5s'>
                            <h1 className='rake-title font-weight-bold mt-sm-5'>
                                RAKE</h1>
                        </MDBAnimation>
                    ...
                    <MDBCol md='6' className='text-center text-md-left mt-xl-5 mb-5'>
                        <MDBAnimation className='text-center mb-5 mt-0' type='fadeInRight' delay='1.6s' >
                            <MDBIcon className='color-violet' icon='file-contract' size='6x' /></MDBAnimation>
                        <MDBAnimation className='text-center mb-5' type='fadeInUp' delay='2.6s'>
                            <MDBIcon className='color-violet-d' icon='filter' size='9x' /></MDBAnimation>
                        <MDBAnimation className='text-center' type='fadeInDown' delay='3.2s'>
                            <MDBIcon className='color-violet' icon='spell-check' size='6x' /></MDBAnimation>
                    </MDBCol>
                </MDBRow>
            </MDBContainer>
        </MDBView >
