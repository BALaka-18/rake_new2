...
manual_keyphrases = ['python', 'guido van rossum', 'first released', '1991', 'notable', 'interpreted', 'high level', 'general purpose', 'design philosophy', 'code readability', 'whitespace', 'language constructs', 'object oriented', 'clear', 'logical', 'small', 'large scale projects']
